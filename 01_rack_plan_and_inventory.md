...
| Bosgame Mini PC   | **Ryzen 7 5825U / 32GB / 1TB NVMe**             | Lab server / services        | **U07 (shelf)**    | 19V DC to PDU    | 1×1G               | USB to SATA dock                  |
...
| Dell OptiPlex     | **Dell OptiPlex**                               | SIEM and log collection      | **U02 (with dock)**| Mains            | 1×1G               | Connected via VLAN 10             |
...
| 4         | Raspberry Pi 5   | Gi1/0/3     | VLAN 40         |                      |
| 5         | Dell OptiPlex    | Gi1/0/4     | VLAN 10         | SIEM                 |
